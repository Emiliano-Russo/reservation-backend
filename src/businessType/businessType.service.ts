...
export class BusinessTypeService {
    ...
    async createBusinessType(createBusinessTypeDto: BusinessTypeCreateDto): Promise<any> {
    ...
    async updateBusinessType(id: string, updateDto: BusinessTypeUpdateDto): Promise<any> {
        ...
        updateData.name = updateData.businessTypeName ?? businessType.name;
